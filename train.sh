# Train
python main_os.py --agent_name SAC1 --alpha 1.0 --reward_epsilon 10000 --mem_size=100000 --env_name="MountainCarContinuous-v0" --interval=200 --n_skills=1 --do_train
...
# Evak
python main_os.py --agent_name SAC1 --alpha 1.0 --reward_epsilon -10000 --mem_size=100000 --env_name="MountainCarContinuous-v0" --interval=200 --n_skills=1
